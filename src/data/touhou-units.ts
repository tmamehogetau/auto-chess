...
export const TOUHOU_UNITS: readonly TouhouUnit[] = [
  ...
  { unitId: "nazrin", displayName: "ナズーリン", unitType: "ranger", cost: 1, hp: 450, attack: 37, attackSpeed: 0.95, movementSpeed: DEFAULT_MOVEMENT_SPEED, range: 4, critRate: 0, critDamageMultiplier: 1.5, damageReduction: 0, factionId: "myourenji" },
  ...
  { unitId: "yoshika", displayName: "宮古芳香", unitType: "vanguard", cost: 1, hp: 550, attack: 39, attackSpeed: 0.9, movementSpeed: DEFAULT_MELEE_MOVEMENT_SPEED, range: 1, critRate: 0, critDamageMultiplier: 1.5, damageReduction: 5, factionId: "shinreibyou" },
  ...
  { unitId: "wakasagihime", displayName: "わかさぎ姫", unitType: "ranger", cost: 1, hp: 390, attack: 41, attackSpeed: 1.0, movementSpeed: DEFAULT_MOVEMENT_SPEED, range: 4, critRate: 0, critDamageMultiplier: 1.5, damageReduction: 0, factionId: "grassroot_network" },
