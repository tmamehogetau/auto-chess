...
const PARALLEL_SAFE_SERVER_TESTS = [
  ...
  "tests/server/game-room/message-handler.test.ts",
  ...
  "tests/server/match-room-controller/battle-orchestrator.test.ts",
  "tests/server/match-room-controller/damage-calculator.test.ts",
  "tests/server/match-room-controller/phase-orchestrator.test.ts",
  "tests/server/match-room-controller/matchup-result-helpers.test.ts",
  "tests/server/match-room-controller/phase-timing.test.ts",
  "tests/server/match-room-controller/player-state-query.test.ts",
  ...
  "tests/server/match-room-controller/shop-manager.test.ts",
