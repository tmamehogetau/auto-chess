...
export const TOUHOU_UNITS: readonly TouhouUnit[] = [
  { unitId: "rin", displayName: "火焔猫燐", unitType: "vanguard", cost: 1, hp: 620, attack: 40, attackSpeed: 0.85, movementSpeed: DEFAULT_MELEE_MOVEMENT_SPEED, range: 1, critRate: 0, critDamageMultiplier: 1.5, damageReduction: 0, factionId: "chireiden" },
  ...
  { unitId: "ichirin", displayName: "雲居一輪＆雲山", unitType: "vanguard", cost: 2, hp: 820, attack: 50, attackSpeed: 0.9, movementSpeed: DEFAULT_MELEE_MOVEMENT_SPEED, range: 1, critRate: 0, critDamageMultiplier: 1.5, damageReduction: 0, factionId: "myourenji" },
  ...
  { unitId: "byakuren", displayName: "聖白蓮", unitType: "vanguard", cost: 5, hp: 1450, attack: 116, attackSpeed: 0.95, movementSpeed: DEFAULT_MELEE_MOVEMENT_SPEED, range: 1, critRate: 0, critDamageMultiplier: 1.5, damageReduction: 0, factionId: "myourenji" },

  { unitId: "yoshika", displayName: "宮古芳香", unitType: "vanguard", cost: 1, hp: 550, attack: 43, attackSpeed: 0.9, movementSpeed: DEFAULT_MELEE_MOVEMENT_SPEED, range: 1, critRate: 0, critDamageMultiplier: 1.5, damageReduction: 0, factionId: "shinreibyou" },
  ...
  { unitId: "kagerou", displayName: "今泉影狼", unitType: "vanguard", cost: 2, hp: 740, attack: 56, attackSpeed: 0.95, movementSpeed: DEFAULT_MELEE_MOVEMENT_SPEED, range: 1, critRate: 0, critDamageMultiplier: 1.5, damageReduction: 0, factionId: "grassroot_network" },
  ...
  { unitId: "momoyo", displayName: "姫虫百々世", unitType: "vanguard", cost: 2, hp: 740, attack: 54, attackSpeed: 0.9, movementSpeed: DEFAULT_MELEE_MOVEMENT_SPEED, range: 1, critRate: 0, critDamageMultiplier: 1.5, damageReduction: 0, factionId: "kou_ryuudou" },
  ...
  { unitId: "junko", displayName: "純狐", unitType: "vanguard", cost: 4, hp: 1120, attack: 92, attackSpeed: 0.85, movementSpeed: DEFAULT_MOVEMENT_SPEED, range: 3, critRate: 0, critDamageMultiplier: 1.5, damageReduction: 0, factionId: "kanjuden" },
