import type { BoardUnitType, UnitId } from "../shared/types";
...
export const TOUHOU_UNITS: readonly TouhouUnit[] = [
  { unitId: "rin", displayName: "火焔猫燐", unitType: "vanguard", cost: 1, hp: 620, attack: 40, attackSpeed: 0.85, range: 1, factionId: "chireiden" },
  { unitId: "satori", displayName: "古明地さとり", unitType: "mage", cost: 3, hp: 820, attack: 70, attackSpeed: 0.9, range: 3, factionId: "chireiden" },
  { unitId: "koishi", displayName: "古明地こいし", unitType: "assassin", cost: 2, hp: 580, attack: 68, attackSpeed: 1.05, range: 1, factionId: "chireiden" },
  { unitId: "utsuho", displayName: "霊烏路空", unitType: "mage", cost: 4, hp: 960, attack: 108, attackSpeed: 0.8, range: 4, factionId: "chireiden" },

  { unitId: "nazrin", displayName: "ナズーリン", unitType: "ranger", cost: 1, hp: 450, attack: 41, attackSpeed: 0.95, range: 4, factionId: "myourenji" },
  { unitId: "ichirin", displayName: "雲居一輪＆雲山", unitType: "vanguard", cost: 2, hp: 820, attack: 50, attackSpeed: 0.9, range: 1, factionId: "myourenji" },
  { unitId: "murasa", displayName: "村紗水蜜", unitType: "mage", cost: 3, hp: 820, attack: 66, attackSpeed: 0.95, range: 3, factionId: "myourenji" },
  { unitId: "shou", displayName: "寅丸星", unitType: "mage", cost: 4, hp: 1010, attack: 81, attackSpeed: 0.95, range: 3, factionId: "myourenji" },
  { unitId: "byakuren", displayName: "聖白蓮", unitType: "vanguard", cost: 5, hp: 1450, attack: 116, attackSpeed: 0.95, range: 1, factionId: "myourenji" },
  ...
  { unitId: "hecatia", displayName: "ヘカーティア・ラピスラズリ", unitType: "mage", cost: 5, hp: 1120, attack: 112, attackSpeed: 0.9, range: 3, factionId: "kanjuden" },

  { unitId: "zanmu", displayName: "日白残無", unitType: "mage", cost: 5, hp: 1180, attack: 118, attackSpeed: 0.85, range: 3, factionId: null },
] as const;
